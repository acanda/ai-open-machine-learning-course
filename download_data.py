...
print("\nTopic 3")
download("https://github.com/Yorko/mlcourse.ai/blob/master/data/mlbootcamp5_train.csv", "topic-3/data/mlbootcamp5_train.csv")
...
print("\nTopic 5")
download("https://github.com/Yorko/mlcourse.ai/tree/master/data/credit_scoring_sample.csv", "topic-5/data/credit_scoring_sample.csv")
